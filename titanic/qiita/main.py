...
# CSVを読み込む
train= pd.read_csv(r"D:\program\programming\study\kaggle_comp\titanic\use_sklearn\data\train.csv")
test= pd.read_csv(r"D:\program\programming\study\kaggle_comp\titanic\use_sklearn\data\test.csv")
